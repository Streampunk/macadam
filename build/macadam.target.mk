...
$(builddir)/macadam.node: GYP_LDFLAGS := $(LDFLAGS_$(BUILDTYPE))
$(builddir)/macadam.node: LIBS := $(LIBS)
$(builddir)/macadam.node: GYP_LIBTOOLFLAGS := $(LIBTOOLFLAGS_$(BUILDTYPE))
$(builddir)/macadam.node: TOOLSET := $(TOOLSET)
$(builddir)/macadam.node: $(OBJS) FORCE_DO_CMD
	$(call do_cmd,solink_module)

all_deps += $(builddir)/macadam.node
# Add target alias
.PHONY: macadam
macadam: $(builddir)/macadam.node

# Short alias for building this executable.
.PHONY: macadam.node
macadam.node: $(builddir)/macadam.node

# Add executable to "all" target.
.PHONY: all
all: $(builddir)/macadam.node
